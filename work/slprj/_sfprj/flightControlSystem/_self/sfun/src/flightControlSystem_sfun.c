  ...
  mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 5:
      {
        if (strcmp(instanceChksum, "swUKTdN1guMTYd66kkuRjcF") == 0) {
     ...
     case 6:
      {
        if (strcmp(instanceChksum, "sH5ylSM1025KeRQ1925bfsB") == 0) {
          extern const mxArray
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 5:
      {
        if (strcmp(tpChksum, "swUKTdN1guMTYd66kkuRjcF") == 0) {
     ...
     case 6:
      {
        if (strcmp(tpChksum, "sH5ylSM1025KeRQ1925bfsB") == 0) {
